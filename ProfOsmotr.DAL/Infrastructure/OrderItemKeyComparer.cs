...
{
    internal class OrderItemKeyComparer : IComparer<string>
    {
        // Сравнивает две строки, являющиеся номером пункта или подпункта приказа
        // https://stackoverflow.com/a/56489000/13467303
        //
